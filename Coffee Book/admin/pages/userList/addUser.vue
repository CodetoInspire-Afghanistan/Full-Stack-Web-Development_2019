...
<!-- Tittle page-->
    <div>
        <div class="row">
            <div class="col">
                <div class="jumbotron">
                <h1 class="display-4">Add news User</h1>
                </div>
            </div>
        </div>
        <!--form-->
                ...
                <div class="col px-5">
                    <form class="px-md-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input v-model="fname" type="text" class="form-control form-control-sm" id="fname" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input v-model="amount" type="number" class="form-control form-control-sm" id="amount" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <!--address input-->
                        <div class="form-group row">
                            <label for="address" class="col-sm-3 col-form-label col-form-label-sm">addres</label>
                            <div class="col-sm-9">
                            <input v-model="address" type="text" class="form-control form-control-sm" id="address" >
                            </div>
                        </div>
